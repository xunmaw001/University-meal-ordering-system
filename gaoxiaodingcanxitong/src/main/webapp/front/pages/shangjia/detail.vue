            ...
            <view class="bottom-content cu-bar bg-white tabbar border shop">
                ...
                <view style="text-align: right;">
					...
					<button @tap="onSubmit" style="margin-right: 10upx;" class="cu-btn bg-red round shadow-blur"
                            :style="{width:'auto',borderRadius:'8rpx',height:'80rpx',fontSize:'28rpx',color:'#fff',backgroundColor:btnColor[3],borderColor:btnColor[3]}">查看商家菜品</button>
                </view>
            </view>
		</view>
...
<script>
	export default {
		...
		methods: {
			...
			async onSubmit(){
				uni.setStorageSync('shangjiaId', this.id);
				this.$utils.tab(`../caipin/list`)
			},
			// 获取详情
			async init() {
